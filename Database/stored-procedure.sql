CREATE OR REPLACE PROCEDURE "SP_MANAGER_GETALLMANAGER" 
(
...
CREATE OR REPLACE PROCEDURE "SP_MANAGER_GETMANAGERBYID" 
(
...
CREATE OR REPLACE PROCEDURE "SP_MANAGER_GETMANAGERBYEMAIL" 
(
...
CREATE OR REPLACE PROCEDURE "SP_MANAGER_DELETEMANAGER" 
(
    MNG_ID IN MANAGER.ID%TYPE
)
AS
...
CREATE OR REPLACE PROCEDURE "SP_MANAGER_ADDMANAGER" 
(
...
CREATE OR REPLACE PROCEDURE "SP_MANAGER_UPDATEMANAGER" 
(
    MNG_ID IN MANAGER.ID%TYPE,
    MNG_ROLE_ID IN MANAGER.ROLE_ID%TYPE,
    MNG_FIRSTNAME IN MANAGER.FIRSTNAME%TYPE,
